			...
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="text-center">
						...
						<div class="panel-body">
							<form autocomplete="off" class="form" method="post" action="Auth/forgot_password">
							...
							<a class="btn btn-lg btn-primary btn-block" href="<?= base_url('sign-in') ?>">Back to Login</a>
						</div>
					</div>
				</div>
			</div>
