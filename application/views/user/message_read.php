							...
							<div class="drop-down dropdown-profile   dropdown-menu">
								<div class="dropdown-content-body">
									<ul>
										...
										<li><a href="<?= base_url(); ?>Login/log_out_user"><i class="icon-key"></i>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<div class="email-left-box"><a href="Compose_message" class="btn btn-primary btn-block">Compose</a>
								...
								<div class="email-right-box">
									...
									<div class="read-content">
										<div class="media pt-5">
											<img class="mr-3 rounded-circle" src="<?php echo base_url() ?>assets/template/images/avatar/1.JPG">
											<div class="media-body">
												<h5 class="m-b-3">Doni Harisandi</h5>
												<p class="m-b-2">27 January 2023</p>
											</div>
										...
										<div class="media mb-4 mt-1">
											<div class="media-body"><span class="float-right">07:23 AM</span>
												<h4 class="m-0 text-primary">A collection of textile samples lay spread
												</h4><small class="text-muted">To:Me,invernessmckenzie@example.com</small>
											</div>
										</div>
										<h5 class="m-b-15">Hi,Ingredia,</h5>
										<p><strong>Ingredia Nutrisha,</strong> A collection of textile samples lay
