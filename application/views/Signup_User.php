			...
			<div class="row justify-content-center">
				<div class="col-lg-8 col-md-8 align-item-center">
					<div class="border border">
						...
						?>
						<form method="POST" action="<?= base_url(); ?>SignUp/proses_user" class="register-form" id="register-form">
							<input type="hidden" class="form-control" name="CanRegisterId">
							<fieldset class="p-4">
								<div class="row">
									<div class="col">
										<input type="hidden" class="form-control mb-3" name="CanRegisterId">
										<input type="text" class="form-control mb-3" placeholder="First name" name="FirstName" required>
									</div>
									<div class="col">
							...
							<h6 style="text-align: center;">Already have an account?<a class="text-primary font-weight-bold" href="<?= base_url(); ?>Login">Sign
									in</a></h6>
						</form>
					</div>
				</div>
