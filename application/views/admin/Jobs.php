		...
		<div class="nk-sidebar">
			<div class="nk-nav-scroll">
				<ul class="metismenu" id="menu">
					...
					<!-- MENU DINAMIS -->
					<?php
					$main_menu = $this->db->get_where('Fn_MenuAdmin (1, 1)', array('MenuAdminParent' => NULL))->result();
					foreach ($main_menu as $main) {
						// cek Apakah Ada submenu 
						// Main Menu
						echo "<li>" . anchor($main->FormName, "<i class='" . $main->Icon . "'></i>" . $main->Description) . "</li>";
					}
					?>
					...
					<li>
						...
						<ul aria-expanded="false">
							<li><a href="Setting/Setting">Account Setting</a></li>
					...
					<li>
						...
						<ul aria-expanded="false">
							<li><a href="#">Recruitment Overview</a></li>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								...
								<p class="text-muted">
									Use the <code>.form-check-inline</code> class if you want
									the checkboxes to appear on the same line
								</p>
								<div class="basic-form">
									<form>
										<div class="form-group">
									...
									<form>
										<div class="form-group">
											...
											<div class="radio disabled">
												<label>
													<input type="radio" name="optradio" disabled="disabled" />Option
													3</label>
											</div>
										</div>
									</form>
							...
							<div class="card-body">
								...
								<div class="basic-form">
									<form>
										...
										<div class="form-group">
											<label>Mutiple select list (hold shift to select more than
												one):</label>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								...
								<p class="text-muted">
									Add the <code>readonly</code> boolean attribute on an input
									to prevent modification of the input’s value
								</p>
								<div class="basic-form">
									<form>
										<div class="form-group">
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Readonly</h4>
								<p class="text-muted">
									use the <code>.form-control-plaintext</code> class to remove
									the default form field styling and preserve the correct
									margin and padding.
								</p>
								<div class="basic-form">
									<form>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								...
								<p class="text-muted">
									use the <code>.form-inline</code> class to for inline form
									styles.
								</p>
								<div class="basic-form">
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								...
								<p class="text-muted">
									Be sure to use
									<code>.col-form-label-sm .col-form-label-lg</code> correctly
									follow the size of
									<code>.form-control-lg and .form-control-sm.</code>
								</p>
								<div class="basic-form">
						...
						<div class="card">
							<div class="card-body">
								...
								<p class="text-muted">
									...
									<code>.col .col-auto</code> so that your columns only take
									up as much space as needed. Put another way, the column
						...
						<div class="card">
							<div class="card-body">
								...
								<p class="text-muted">
									...
									to prevent user interactions and make it appear lighter.
								</p>
								<div class="basic-form">
									<form>
										<fieldset disabled="disabled">
											...
											<button type="submit" class="btn btn-dark m-t-20">
												Submit
											</button>
										</fieldset>
									</form>
