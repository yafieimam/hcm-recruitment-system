...
<body>
    ...
    ***********************************-->
						...
						<div class="row">
							...
							<div class="col-lg-8" style="float: center;">
									...
									<div class="card-body">
										<form>
											...
											<div class="card-footer">
												<button style="float: right;" class="btn btn-danger" type="submit" value="submit">Save</button>
											</div>
										</form>
									</div>
								</div>
								<div class="card border-primary">
									<div class="card-header" style="color:#a9a9a9;">
										<h4>Change Email</h4>
										<p>To change your email, please complete the following field</p>
									</div>
									<div class="card-body">
										<form method="" action="submit">
											<div class="form-group">
												<input type="text" class="form-control" id="formGroupExampleInput" placeholder="Current Password">
											</div>
											<div class="form-group">
												<input type="text" class="form-control" id="formGroupExampleInput2" placeholder="New email address">
											</div>
											<div class="card-footer">
												<button style="float: right;" class="btn btn-danger" type="submit" value="submit">Save</button>
											</div>
	...
	<sc ript src="<?php echo base_url() ?>assets/template/js/styleSwitcher.js">
		...
		<script src="<?php echo base_url() ?>assets/template/plugins/chart.js/Chart.bundle.min.js">
		</script>
