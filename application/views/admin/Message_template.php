...
<head>
	...
	<!-- Custom Stylesheet -->
	<link href="<?php echo base_url() ?>assets/template/plugins/summernote/dist/summernote.css" rel="stylesheet">
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-12">
						...
						<div class="card">
							<div class="card-body">
								<div class="inline-editor">
									...
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elitconsectetur adipisicing
									...
									<ul class="list-icons">
										...
										<li><i class="fa fa-check text-success"></i> Integer molestie lorem at massa
										</li>
									</ul>
								</div>
							</div>
						...
						<div class="card">
							<div class="card-body">
								<div class="click2edit m-b-40">Click on Edite button and change the text then save it.
								</div>
...
*************************-->
	...
	<script src="<?php echo base_url() ?>assets/template/plugins/summernote/dist/summernote.min.js"></script>
	<script src="<?php echo base_url() ?>assets/template/plugins/summernote/dist/summernote-init.js"></script>
